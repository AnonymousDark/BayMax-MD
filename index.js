...
async function startA17() {
  ...
  console.log(color('\nHello, I am Mr Juice, the main Developer of this bot.\n\nThanks for using: BayMax Bot.', 'aqua'))
  console.log(color('\nYou can follow me on GitHub: mrjuice01', 'aqua'))

  const { state, saveCreds } = await useMultiFileAuthState("./BAYMAX-SESSION");
  const A17 = A17Connect({
    logger: pino({ level: "silent" }),
    printQRInTerminal: true,
    browser: ["BAYMAX Bot", "Safari", "3.O"],
    auth: state,
  });
 ...
 */
  ...
  I am *BayMax Bot*, Welcome to ${metadata.subject}.
  ...
  *Group Description:*
  ...
  I hope you won't come back, because You won't be missed!
  `
