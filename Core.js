...
module.exports = A17 = async (A17, m, chatUpdate, store) => {
  try {
    ...
    //     const menulist = `
    //     Konichiwa ${pushname} dear 👋. I am ${global.BotName}, a bot developed by: Mr Juice to take your WhatsApp usage into next level.
    ...
    //     ©️ *${global.BotName}* All Rights Reserved by: *Mr Juice*
    //     `
 ...
 */
    ...
    switch (command) {
      ...
      case 'sc': case 'script': case 'sourcecode': {
        ...
        let { data } = await axios.get('https://api.github.com/repos/mrjuice01/BayMax-MD');
        teks = `*BayMax Script*\n\n*Total Stars*: ${data.stargazers_count}⭐\n*Total Forks*: ${data.forks_count} forks\n*GitHub*: https://github.com/mrjuice01/BayMax-MD\n\nDont forget to follow me on *GitHub* and give a ⭐️ to my projects. `
        /*  let buttons = [
        ...
        let buttonMessage = {
          ...
          contextInfo: {
            externalAdreply: {
              title: "Powered By Mr Juice",
              body: " ",
              thumbnail: fs.readFileSync("Assets/pic2.jpg"),
              mediaType: 1,
              //mediaUrl: 'https://wallpapercave.com/wp/wp10524580.jpg',
              //sourceUrl: "https://wallpapercave.com/wp/wp10524580.jpg"
              mediaUrl: 'github.com/mrjuice01/BayMax-MD',
              sourceUrl: "github.com/mrjuice01/BayMax-MD"
            }
          }
  ...
  case 'qt': {
    ...
    break;
      ...
      case 'repo': case 'botrepo': {
        ...
        A17.sendMessage(from, { react: { text: "💫", key: m.key } })
        reply(`⚙ My Source Code is </> - https://github.com/mrjuice01/BayMax-MD`)
      }
        break;
  ...
  *Response Speed*: ${latensie.toFixed(4)} seconds
  ...
  👉 Following : ${gitdata.following}`
      ...
      case 'listpc': {
        ...
        let teks = ` 「  BayMax-MD's pm user list  」\n\nTotal ${anu.length} users are using BayMax-MD in personal chat.`
        for (let i of anu) {
      ...
      case 'listgc': {
        ...
        let teks = ` 「  BayMax-MD's group user list  」\n\nTotal ${anu.length} users are using bot in Groups.`
        for (let i of anu) {
...
*Message : ${text}*\n\n`
      ...
      */
      ...
      case 'firework': case 'skeleton': case 'blackpink': case 'sand': case 'glue': case '1917': case 'leaves': {
        ...
        A17.sendMessage(m.chat, { image: { url: anu }, caption: `Made by BayMax Bot By Mr Juice...  🪄` }, { quoted: m })
      }
...
_Click the button below to download_`
      ...
      case 'music': case 'p': case 'play': case 'song': case 'ytplay': {
       ...
       caption: `「  BayMax-MD Youtube Player 2.0  」
  ...
  🔗 *Url :* ${anu.url}\n`,
      ...
      case 'ytvd': case 'video': case 'ytvideo': case 'ytmp4': {
        ...
        A17.sendMessage(from, { video: { url: ytmp4play.videoUrl }, mimetype: "video/mp4", caption: anu.title + ' By *BayMax-MD*', }, { quoted: m })
      }
      ...
      let buttonMessage = {
      image: { url: anu.thumbnail },
      caption: `「  BayMax-MD Youtube Downloader 2.0  」
...
`.trim())
      ...
      //   const commonCaption = 'Check out this image from Pinterest By BayMax';
      //   for (let i = 0; i < results.length; i++) {
      ...
      case 'swm': case 'take': case 'stickerwm': case 'steal': {
        ...
        if (!args.join(" ")) return reply(`Like use -take BayMax|By: Mr Juice`)
        const swn = args.join(" ")
      ...
      case 'handsomecheck':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "😺", key: m.key } })
        if (!text) return reply(`Tag Someone, Example : ${prefix + command} @Mr Juice`)
